@extends('layouts.app')
@section('pageTitle', 'උපාධීධාරී ශිෂ්‍ය ලියාපදිංචි විස්තර')
@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <div style="font-size:1.5em;">{{ __('උපාධීධාරී ශිෂ්‍ය ලියාපදිංචි විස්තර') }}</div>
                </div>
            </div>
                    ...
                    <table id="studentlistTable" class="table table-striped table-bordered display studentlistTable" style="width:105%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$student->nic}}</td>
                                <td>{{$student->dob}}</td>
                                <td>{{$student->degree_reg_no}}</td>
                                <td><a href="{{ url('admin/report/student/degree/'.$student->stu_id) }}"><i class="fas fa-eye"></a></i></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
