  ...
  <div class="col-md-12" >
   <div class="row link_info justify-content-center bg-white" style=" height: 250px; color: white; padding-top: 0;">
    ...
    <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
     <h4 class="bg-white text-black">Contact Us</h4>
  ...
  <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
   <h4 class="bg-white text-black">Imporant Link</h4>
  ...
  <li style="line-height:2">
   ...
   Opendata Portal of Sri Lanka
   </a>
  </li>
 </div>
 <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
   <h4 class="bg-white text-black">Social Media</h4>
...
<div class="copyright" >
  ...
  <div class="row justify-content-center align-content-center">
    ...
    <span style="text-align:center;"> 
      Office of the Deputy Chief Secretory (Planning), Sabaragamuwa Provincial Council
      <br/>
