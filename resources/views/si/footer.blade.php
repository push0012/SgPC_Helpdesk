  ...
  <div class="col-md-12" >
   <div class="row link_info justify-content-center bg-white" style=" height: 250px; color: white; padding-top: 0;">
    ...
    <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
     <h4 class="bg-white text-black" style="padding-top:5px; padding-bottom:5px;">අමතන්න</h4>
  ...
  <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
   <h4 class="bg-white text-black" style="padding-top:5px; padding-bottom:5px;">වැදගත් සබැඳි </h4>
 ...
 <div class="col-md-4 col-sm-12 footer-bar" style="background-color:#000000;">
   <h4 class="bg-white text-black" style="padding-top:5px; padding-bottom:5px;">සමාජ මාධ්‍ය</h4>
  ...
  <h4 class="bg-white text-black" style="padding-top:5px; padding-bottom:5px;">පරිශීලකයින්</h4>
